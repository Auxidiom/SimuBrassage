...
/*
/*
 * Cette classe a �t� inspir�e de la l'exemple suivant :
...
public final class I18N {
	...
	public static List<Locale> getSupportedLocales() {
		return new ArrayList<>(
				Arrays.asList(ControleurDonnees.localeFR, ControleurDonnees.localeEN));
	}
	...
	public static Locale getDefaultLocale() {
		...
		return getSupportedLocales().contains(sysDefault) ? sysDefault : ControleurDonnees.localeFR;
	}
	...
	public static String get(final String key, final Object... args) {
		ResourceBundle bundle = ResourceBundle.getBundle(ControleurDonnees.urlFichiersTrad, getLocale());
